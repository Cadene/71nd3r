<div class="actions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('superlike'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($action['Action']['like']); ?>&nbsp;</td>
		<td><?php echo h($action['Action']['superlike']); ?>&nbsp;</td>
		<td><?php echo h($action['Action']['pass']); ?>&nbsp;</td>
		<td><?php echo h($action['Action']['match']); ?>&nbsp;</td>
		<td><?php echo h($action['Action']['match_id']); ?>&nbsp;</td>
		<td>
